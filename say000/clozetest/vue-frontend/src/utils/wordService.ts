...
const queryWordInternal = async (word: string, _contextText?: string): Promise<WordInfo | null> => {
...
export const compareWordData = (_word: string, databaseResult: WordInfo | null, localResult: WordInfo | null): {
...
// 增强的单词查询函数，包含数据对比
export const queryWordWithComparison = async (word: string, _contextText?: string): Promise<{
